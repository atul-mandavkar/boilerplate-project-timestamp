...
/*if(d.getTime()){
      tempTime = [d.getDate(), d.getMonth(), d.getFullYear()];
      console.log(tempTime)
      d.setUTCDate(tempTime[0])
      d.setUTCMonth(tempTime[1])
      d.setUTCFullYear(tempTime[2])
      console.log(d.toUTCString())
      unixVal = Date.parse(inputValue)
      utcVal = d.toUTCString();
      res.json({unix: unixVal, utc: utcVal});
    } */
